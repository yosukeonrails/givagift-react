...
import {INITIALIZE_RESULTS,CHANGE_MODE, SIGN_UP_USER, GET_ALL_QUERY,SAVE_GIFT_FORM, SAVE_CHOSEN_BUBBLE,FIND_GIFT_FORM_BY_ID, GET_LAST_GIFT_FORM, DELETE_LAST_GIFT_FORM,CHANGE_REDIRECT,ADD_BUBBLE,BUBBLE_COUNT,LAYOUT_STATE ,LOG_OUT,GET_GIFT_LISTS,SET_CURRENT_QUERY, ZERO_QUESTION, SAVE_RESULT_DATA,SAVE_LIST_INFO, ARROW_RIGHT,GET_FACEBOOK_USER, LOG_MOCK_USER, NEXT_QUESTION, LOG_IN, CALL_AMAZON,CALL_AMAZON_CALLS, SET_ANSWER_POINTS, SELECT_ANSWER, SUBMIT_ANSWER_POINT, GET_MAX, SET_QUERY} from '../actions/index';
...
var reducer = function(state, action) {
  ...
  return handle(state, action, {
    ...
    return handle(state, action, {
      ...
      success: s => ({ ...s, queryArray:action.payload  }),
                           ...
                           case SAVE_GIFT_FORM:
                            ...
                            case SIGN_UP_USER:
                                 ...
                                 return handle(state, action, {
                                   ...
                                   success: s => ({ ...s, signedUpedUser:action.payload}),
